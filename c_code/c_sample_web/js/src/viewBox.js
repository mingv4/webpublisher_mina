...
/*setTimeout(function(){},100);  --- 일정 시간이 지난 후에 함수를 실행하는 방법
  
  setInterval(function(){} ,시간); --- 일정 시간 간격을 두고 함수를 실행하는 방법
  clearInterval(setInterval 함수이름);*/
...
*/ 
  ...
  var slideN = 0; //최초의 값
  var timed = 2000; // 일정 시간마다 처리하게 하는 시간
