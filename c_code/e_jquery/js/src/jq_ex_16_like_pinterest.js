...
(function($){
     ...
     */
     ...
     /* 실제 데이터 형식 에서는
     [
         { "title" : "카드 제목", "content" : "카드 내용",
         "imgSrc" : 'random_01.jpg', "imgAlt" : '이미지 설명'},
         { "title" : "카드 제목", "content" : "카드 내용",
         "imgSrc" : 'random_02.jpg', "imgAlt" : '이미지 설명'},
         { "title" : "카드 제목", "content" : "카드 내용",
         "imgSrc" : 'random_03.jpg', "imgAlt" : '이미지 설명'}
     ];
     */

    var cardData = [];
    var k = 0, l;
    var url="../img/sample_02/";
    var imgT = 'random_';
    for ( ; k < 19; k++){
        if(k < 9){
          l='0'+(k+1);  // 8 ->009 
